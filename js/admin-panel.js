...
async function verDetalle(idFactura) {
  ...
  if (body) {
    // Si la factura se pagó con "Pago Combinado", se muestra el desglose
    // línea por línea guardado en factura.pagos_combinados (requiere haber
    // ejecutado supabase/pagos_combinados.sql); si no existe o está vacío,
    // simplemente no se muestra esta sección extra.
